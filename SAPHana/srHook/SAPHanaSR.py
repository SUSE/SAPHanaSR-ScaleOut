...
### ANGI TODO - check # SAPHanaSR needs SAP HANA 2.0 SPS4 (2.00.040.00) as minimum version
"""
import os, time

fhSRHookVersion = "0.170.5.1001.1647"
        ...
        def srConnectionChanged(self, ParamDict, **kwargs):
            ...
            if mySRS == "":
                ...
                if rc != 0:
                    ...
                    if globHOOK:
                        fallbackFileObject.write("hana_{0}_glob_srHook = {1}".format(mysid, mySRS))
